...
class HandTracker:
    def __init__(self):
        ...
        # Joint velocity publisher for UR5e - Float64MultiArray
        self.cmd_pub = rospy.Publisher('/joint_group_vel_controller/command', Float64MultiArray, queue_size=1)
    ...
    def image_callback(self, msg):
        ...
        self.cmd_pub.publish(velocity_msg)
